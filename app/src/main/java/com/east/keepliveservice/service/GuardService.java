 ...
 * |---------------------------------------------------------------------------------------------------------------|
 *
 *  @description: 守护服务，跟MessageService相互启动，流氓的保活
 *  @author: jamin
 *  @date: 2020/5/25
 * |---------------------------------------------------------------------------------------------------------------|
 */
public class GuardService extends Service {
    ...
    private static final String PUSH_CHANNEL_ID = "PUSH_NOTIFY_ID_GUARD";
    private static final String PUSH_CHANNEL_NAME = "PUSH_NOTIFY_NAME_GUARD";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        builder.setContentTitle("守护通知标题")//设置通知栏标题
                .setContentIntent(pendingIntent) //设置通知栏点击意图
                .setContentText("守护通知内容")
                .setNumber(1000)
                .setTicker("守护通知内容") //通知首次出现在通知栏，带上升动画效果的
    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            bindService(new Intent(GuardService.this,MessageService.class),this,BIND_AUTO_CREATE);
        }
    };
}
